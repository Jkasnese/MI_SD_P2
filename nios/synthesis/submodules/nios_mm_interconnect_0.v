...
module nios_mm_interconnect_0 (
		...
		output wire [1:0]  btn_s1_address,                                 //                                   btn_s1.address
		input  wire [31:0] btn_s1_readdata,                                //                                         .readdata
	...
	wire  [13:0] lcd_s1_agent_m0_address;                                                            // lcd_s1_agent:m0_address -> lcd_s1_translator:uav_address
	...
	wire  [92:0] lcd_s1_agent_rf_source_data;                                                        // lcd_s1_agent:rf_source_data -> lcd_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] lcd_s1_agent_rsp_fifo_out_data;                                                     // lcd_s1_agent_rsp_fifo:out_data -> lcd_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> lcd_s1_agent:cp_data
	...
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> rx_read_s1_agent:cp_valid
	wire  [91:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> rx_read_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // rx_read_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire  [10:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> rx_read_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> rx_read_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> rx_read_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> rx_options_s1_agent:cp_valid
	wire  [91:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> rx_options_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // rx_options_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [10:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> rx_options_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> rx_options_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> rx_options_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> rx_parity_s1_agent:cp_valid
	wire  [91:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> rx_parity_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                              // rx_parity_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [10:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> rx_parity_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> rx_parity_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> rx_parity_s1_agent:cp_endofpacket
	...
	wire  [91:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> leds_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                              // leds_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [10:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> leds_s1_agent:cp_channel
	...
	wire  [31:0] btn_s1_agent_m0_readdata;                                                           // btn_s1_translator:uav_readdata -> btn_s1_agent:m0_readdata
	wire         btn_s1_agent_m0_waitrequest;                                                        // btn_s1_translator:uav_waitrequest -> btn_s1_agent:m0_waitrequest
	wire         btn_s1_agent_m0_debugaccess;                                                        // btn_s1_agent:m0_debugaccess -> btn_s1_translator:uav_debugaccess
	wire  [13:0] btn_s1_agent_m0_address;                                                            // btn_s1_agent:m0_address -> btn_s1_translator:uav_address
	wire   [3:0] btn_s1_agent_m0_byteenable;                                                         // btn_s1_agent:m0_byteenable -> btn_s1_translator:uav_byteenable
	wire         btn_s1_agent_m0_read;                                                               // btn_s1_agent:m0_read -> btn_s1_translator:uav_read
	wire         btn_s1_agent_m0_readdatavalid;                                                      // btn_s1_translator:uav_readdatavalid -> btn_s1_agent:m0_readdatavalid
	wire         btn_s1_agent_m0_lock;                                                               // btn_s1_agent:m0_lock -> btn_s1_translator:uav_lock
	wire  [31:0] btn_s1_agent_m0_writedata;                                                          // btn_s1_agent:m0_writedata -> btn_s1_translator:uav_writedata
	wire         btn_s1_agent_m0_write;                                                              // btn_s1_agent:m0_write -> btn_s1_translator:uav_write
	wire   [2:0] btn_s1_agent_m0_burstcount;                                                         // btn_s1_agent:m0_burstcount -> btn_s1_translator:uav_burstcount
	wire         btn_s1_agent_rf_source_valid;                                                       // btn_s1_agent:rf_source_valid -> btn_s1_agent_rsp_fifo:in_valid
	wire  [92:0] btn_s1_agent_rf_source_data;                                                        // btn_s1_agent:rf_source_data -> btn_s1_agent_rsp_fifo:in_data
	wire         btn_s1_agent_rf_source_ready;                                                       // btn_s1_agent_rsp_fifo:in_ready -> btn_s1_agent:rf_source_ready
	wire         btn_s1_agent_rf_source_startofpacket;                                               // btn_s1_agent:rf_source_startofpacket -> btn_s1_agent_rsp_fifo:in_startofpacket
	wire         btn_s1_agent_rf_source_endofpacket;                                                 // btn_s1_agent:rf_source_endofpacket -> btn_s1_agent_rsp_fifo:in_endofpacket
	wire         btn_s1_agent_rsp_fifo_out_valid;                                                    // btn_s1_agent_rsp_fifo:out_valid -> btn_s1_agent:rf_sink_valid
	wire  [92:0] btn_s1_agent_rsp_fifo_out_data;                                                     // btn_s1_agent_rsp_fifo:out_data -> btn_s1_agent:rf_sink_data
	wire         btn_s1_agent_rsp_fifo_out_ready;                                                    // btn_s1_agent:rf_sink_ready -> btn_s1_agent_rsp_fifo:out_ready
	wire         btn_s1_agent_rsp_fifo_out_startofpacket;                                            // btn_s1_agent_rsp_fifo:out_startofpacket -> btn_s1_agent:rf_sink_startofpacket
	wire         btn_s1_agent_rsp_fifo_out_endofpacket;                                              // btn_s1_agent_rsp_fifo:out_endofpacket -> btn_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_010_src_valid;                                                              // cmd_mux_010:src_valid -> btn_s1_agent:cp_valid
	wire  [91:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> btn_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                              // btn_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [10:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> btn_s1_agent:cp_channel
	wire         cmd_mux_010_src_startofpacket;                                                      // cmd_mux_010:src_startofpacket -> btn_s1_agent:cp_startofpacket
	wire         cmd_mux_010_src_endofpacket;                                                        // cmd_mux_010:src_endofpacket -> btn_s1_agent:cp_endofpacket
	...
	wire  [91:0] lcd_s1_agent_rp_data;                                                               // lcd_s1_agent:rp_data -> router_007:sink_data
	...
	wire         rx_read_s1_agent_rp_valid;                                                          // rx_read_s1_agent:rp_valid -> router_008:sink_valid
	wire  [91:0] rx_read_s1_agent_rp_data;                                                           // rx_read_s1_agent:rp_data -> router_008:sink_data
	wire         rx_read_s1_agent_rp_ready;                                                          // router_008:sink_ready -> rx_read_s1_agent:rp_ready
	wire         rx_read_s1_agent_rp_startofpacket;                                                  // rx_read_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         rx_read_s1_agent_rp_endofpacket;                                                    // rx_read_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         rx_options_s1_agent_rp_valid;                                                       // rx_options_s1_agent:rp_valid -> router_009:sink_valid
	wire  [91:0] rx_options_s1_agent_rp_data;                                                        // rx_options_s1_agent:rp_data -> router_009:sink_data
	wire         rx_options_s1_agent_rp_ready;                                                       // router_009:sink_ready -> rx_options_s1_agent:rp_ready
	wire         rx_options_s1_agent_rp_startofpacket;                                               // rx_options_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         rx_options_s1_agent_rp_endofpacket;                                                 // rx_options_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         rx_parity_s1_agent_rp_valid;                                                        // rx_parity_s1_agent:rp_valid -> router_010:sink_valid
	wire  [91:0] rx_parity_s1_agent_rp_data;                                                         // rx_parity_s1_agent:rp_data -> router_010:sink_data
	wire         rx_parity_s1_agent_rp_ready;                                                        // router_010:sink_ready -> rx_parity_s1_agent:rp_ready
	wire         rx_parity_s1_agent_rp_startofpacket;                                                // rx_parity_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         rx_parity_s1_agent_rp_endofpacket;                                                  // rx_parity_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire  [91:0] leds_s1_agent_rp_data;                                                              // leds_s1_agent:rp_data -> router_011:sink_data
	...
	wire         btn_s1_agent_rp_valid;                                                              // btn_s1_agent:rp_valid -> router_012:sink_valid
	wire  [91:0] btn_s1_agent_rp_data;                                                               // btn_s1_agent:rp_data -> router_012:sink_data
	wire         btn_s1_agent_rp_ready;                                                              // router_012:sink_ready -> btn_s1_agent:rp_ready
	wire         btn_s1_agent_rp_startofpacket;                                                      // btn_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire         btn_s1_agent_rp_endofpacket;                                                        // btn_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire         rx_read_s1_agent_rdata_fifo_src_valid;                                              // rx_read_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] rx_read_s1_agent_rdata_fifo_src_data;                                               // rx_read_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         rx_read_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_006:in_0_ready -> rx_read_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> rx_read_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> rx_read_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // rx_read_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> rx_read_s1_agent:rdata_fifo_sink_error
	wire         rx_options_s1_agent_rdata_fifo_src_valid;                                           // rx_options_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] rx_options_s1_agent_rdata_fifo_src_data;                                            // rx_options_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         rx_options_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_007:in_0_ready -> rx_options_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> rx_options_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> rx_options_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // rx_options_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> rx_options_s1_agent:rdata_fifo_sink_error
	wire         rx_parity_s1_agent_rdata_fifo_src_valid;                                            // rx_parity_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] rx_parity_s1_agent_rdata_fifo_src_data;                                             // rx_parity_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         rx_parity_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_008:in_0_ready -> rx_parity_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> rx_parity_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> rx_parity_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                                  // rx_parity_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> rx_parity_s1_agent:rdata_fifo_sink_error
	...
	wire         btn_s1_agent_rdata_fifo_src_valid;                                                  // btn_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire  [33:0] btn_s1_agent_rdata_fifo_src_data;                                                   // btn_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire         btn_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_010:in_0_ready -> btn_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_010_out_0_valid;                                                  // avalon_st_adapter_010:out_0_valid -> btn_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_010_out_0_data;                                                   // avalon_st_adapter_010:out_0_data -> btn_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_010_out_0_ready;                                                  // btn_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire   [0:0] avalon_st_adapter_010_out_0_error;                                                  // avalon_st_adapter_010:out_0_error -> btn_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (btn_s1_agent_m0_address),                        // avalon_universal_slave_0.address
		.uav_burstcount         (btn_s1_agent_m0_burstcount),                     //                         .burstcount
		.uav_read               (btn_s1_agent_m0_read),                           //                         .read
		.uav_write              (btn_s1_agent_m0_write),                          //                         .write
		.uav_waitrequest        (btn_s1_agent_m0_waitrequest),                    //                         .waitrequest
		.uav_readdatavalid      (btn_s1_agent_m0_readdatavalid),                  //                         .readdatavalid
		.uav_byteenable         (btn_s1_agent_m0_byteenable),                     //                         .byteenable
		.uav_readdata           (btn_s1_agent_m0_readdata),                       //                         .readdata
		.uav_writedata          (btn_s1_agent_m0_writedata),                      //                         .writedata
		.uav_lock               (btn_s1_agent_m0_lock),                           //                         .lock
		.uav_debugaccess        (btn_s1_agent_m0_debugaccess),                    //                         .debugaccess
		.av_address             (btn_s1_address),                                 //      avalon_anti_slave_0.address
		.av_readdata            (btn_s1_readdata),                                //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
		.av_writedata           (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (btn_s1_agent_m0_address),                        //              m0.address
		.m0_burstcount           (btn_s1_agent_m0_burstcount),                     //                .burstcount
		.m0_byteenable           (btn_s1_agent_m0_byteenable),                     //                .byteenable
		.m0_debugaccess          (btn_s1_agent_m0_debugaccess),                    //                .debugaccess
		.m0_lock                 (btn_s1_agent_m0_lock),                           //                .lock
		.m0_readdata             (btn_s1_agent_m0_readdata),                       //                .readdata
		.m0_readdatavalid        (btn_s1_agent_m0_readdatavalid),                  //                .readdatavalid
		.m0_read                 (btn_s1_agent_m0_read),                           //                .read
		.m0_waitrequest          (btn_s1_agent_m0_waitrequest),                    //                .waitrequest
		.m0_writedata            (btn_s1_agent_m0_writedata),                      //                .writedata
		.m0_write                (btn_s1_agent_m0_write),                          //                .write
		.rp_endofpacket          (btn_s1_agent_rp_endofpacket),                    //              rp.endofpacket
		.rp_ready                (btn_s1_agent_rp_ready),                          //                .ready
		.rp_valid                (btn_s1_agent_rp_valid),                          //                .valid
		.rp_data                 (btn_s1_agent_rp_data),                           //                .data
		.rp_startofpacket        (btn_s1_agent_rp_startofpacket),                  //                .startofpacket
		...
		.rf_sink_ready           (btn_s1_agent_rsp_fifo_out_ready),                //         rf_sink.ready
		.rf_sink_valid           (btn_s1_agent_rsp_fifo_out_valid),                //                .valid
		.rf_sink_startofpacket   (btn_s1_agent_rsp_fifo_out_startofpacket),        //                .startofpacket
		.rf_sink_endofpacket     (btn_s1_agent_rsp_fifo_out_endofpacket),          //                .endofpacket
		.rf_sink_data            (btn_s1_agent_rsp_fifo_out_data),                 //                .data
		.rf_source_ready         (btn_s1_agent_rf_source_ready),                   //       rf_source.ready
		.rf_source_valid         (btn_s1_agent_rf_source_valid),                   //                .valid
		.rf_source_startofpacket (btn_s1_agent_rf_source_startofpacket),           //                .startofpacket
		.rf_source_endofpacket   (btn_s1_agent_rf_source_endofpacket),             //                .endofpacket
		.rf_source_data          (btn_s1_agent_rf_source_data),                    //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_010_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_010_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_010_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_010_out_0_error),              //                .error
		.rdata_fifo_src_ready    (btn_s1_agent_rdata_fifo_src_ready),              //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (btn_s1_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_src_data     (btn_s1_agent_rdata_fifo_src_data),               //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) btn_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (btn_s1_agent_rf_source_data),                    //        in.data
		.in_valid          (btn_s1_agent_rf_source_valid),                   //          .valid
		.in_ready          (btn_s1_agent_rf_source_ready),                   //          .ready
		.in_startofpacket  (btn_s1_agent_rf_source_startofpacket),           //          .startofpacket
		.in_endofpacket    (btn_s1_agent_rf_source_endofpacket),             //          .endofpacket
		.out_data          (btn_s1_agent_rsp_fifo_out_data),                 //       out.data
		.out_valid         (btn_s1_agent_rsp_fifo_out_valid),                //          .valid
		.out_ready         (btn_s1_agent_rsp_fifo_out_ready),                //          .ready
		.out_startofpacket (btn_s1_agent_rsp_fifo_out_startofpacket),        //          .startofpacket
		.out_endofpacket   (btn_s1_agent_rsp_fifo_out_endofpacket),          //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	nios_mm_interconnect_0_router_002 router_012 (
		.sink_ready         (btn_s1_agent_rp_ready),                          //      sink.ready
		.sink_valid         (btn_s1_agent_rp_valid),                          //          .valid
		.sink_data          (btn_s1_agent_rp_data),                           //          .data
		.sink_startofpacket (btn_s1_agent_rp_startofpacket),                  //          .startofpacket
		.sink_endofpacket   (btn_s1_agent_rp_endofpacket),                    //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (btn_s1_agent_rdata_fifo_src_data),               //     in_0.data
		.in_0_valid     (btn_s1_agent_rdata_fifo_src_valid),              //         .valid
		.in_0_ready     (btn_s1_agent_rdata_fifo_src_ready),              //         .ready
